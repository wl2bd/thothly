...
// The landing's one interactive island. The whole hero fold lives here (not just
// the card): its padding, inner gap, heads-up and scroll cue all read from the
// search state, so the section IS the client boundary. Everything around it —
// header, How it works, FAQ, footer — stays server-rendered.
